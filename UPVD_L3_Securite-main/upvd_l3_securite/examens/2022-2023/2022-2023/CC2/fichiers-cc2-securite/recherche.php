 ...
 <?php
   ...
   { 
    ...
    echo "<H3> Résultat recherche pour keyword=" . $_POST['keyword']. ":</H3> ";
       ...
       $sql = 'SELECT auteur, titre, annee FROM Livres WHERE titre LIKE \'%'.$_POST['keyword'].'%\' ORDER BY id  DESC LIMIT 20 ;';
       //echo "requete =" . $sql . "<BR>";
       ...
       if ($result->num_rows > 0)
       {
          ...
          while($row = $result->fetch_assoc()) {
            echo "<li>";
            echo "<i>" . $row["titre"]. "</i> de " . $row["auteur"]. " publié en "  . $row["annee"]. ".<br>";
            echo "</li>";
          }
          echo "</ul>";
       }
