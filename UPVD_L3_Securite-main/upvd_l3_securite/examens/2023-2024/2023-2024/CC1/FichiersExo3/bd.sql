...
CREATE TABLE Users( id INT  AUTO_INCREMENT,  login VARCHAR(30), passwd VARCHAR(30), email VARCHAR(50), PRIMARY KEY(id));
...
# Users
INSERT INTO Users(login,passwd,email) VALUES('toto','1234','toto@monroyaume.fr');
INSERT INTO Users(login,passwd,email) VALUES('luke','bidon','lukeskywalker@monroyaume.fr');
